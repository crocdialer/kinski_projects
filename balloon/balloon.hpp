...
namespace kinski
{
    class balloon : public ViewerApp
    {
    private:
        enum TextureEnum{TEXTURE_BG_01 = 0, TEXTURE_BG_02 = 1, TEXTURE_BALLOON = 2};

        gl::ScenePtr m_2d_scene = gl::Scene::create();
        ...
        m_background_asset_dir = Property_<string>::create("background asset dir");
        ...
        void create_sprite_mesh();
        void create_background_mesh();

    public:
        balloon(int argc = 0, char *argv[] = nullptr):ViewerApp(argc, argv){};
        void setup() override;
...
{
    auto theApp = std::make_shared<kinski::balloon>(argc, argv);
