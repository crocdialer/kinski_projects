...
//    auto plane = gl::Mesh::create(gl::Geometry::create_plane(4.f, 4.f, 1, 1), gl::Material::create());
//    plane->set_position(glm::vec3(-5, 0, 0));
//    scene()->add_object(plane);
//    gl::compute_half_edges(plane->geometry());
//
//    auto sphere = gl::Mesh::create(gl::Geometry::create_box(glm::vec3(.5f)), gl::Material::create());
//    sphere->set_position(glm::vec3(5, 0, 0));
//    scene()->add_object(sphere);
//    gl::compute_half_edges(sphere->geometry());
}
...
gl::MeshPtr ModelViewer::load_asset(const std::string &the_path)
{
    ...
    if(m)
    {
        ...
        gl::compute_half_edges(m->geometry());
    }
    return m;
}
